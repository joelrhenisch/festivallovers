...
<div class="singleevent__descriptioncontainer">
    <div class="singleevent__description">
        ...
        <div class="singleevent__descriptionTop col-9">
            ...
            <div class="singleevent__descriptionText col-8">
            ...
            <div class="singleevent__descriptionBreadcrumb col-2">
                ...
                <div class="singleevent__descriptionAdd">
                    <img src={{asset('icons/unterstuetzt_von_ceros.png')}} alt="Unterstützt_von_Ceros">
                </div>
